...
class Ping(PacketBody, VBANApplicationData):
    ...
    def unpack(cls, data):
        ...
        if len(data) < expected_size:
            raise ValueError(
                f"Insufficient data for Ping packet: expected {expected_size} bytes, got {len(data)}"
            )
