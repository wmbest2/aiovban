...
async def run_loop():
    ...
    receiver = VBANAudioPlayer(stream=windows_mic_out, pyaudio=pyaudio_instance, device_index=receiver_device)
    sender = VBANAudioSender(stream=mac_in, pyaudio=pyaudio_instance, device_index=sender_device)
